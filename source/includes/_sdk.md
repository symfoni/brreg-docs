...
<aside class=”notice”>You are responsible for validating that the user is the chairman of the company. This will be done by the platform in later version.</aside>
